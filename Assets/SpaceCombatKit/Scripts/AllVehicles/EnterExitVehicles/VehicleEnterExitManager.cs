...
namespace VSX.UniversalVehicleCombat
{
    ...
    public class VehicleEnterExitManager : MonoBehaviour
    {
        ...
        public VehicleEnterExitManager Child { get { return child; } }
        ...
        protected virtual void Reset()
        {
            ...
            enterableVehicleClasses = new List<VehicleClass>((VehicleClass[])System.Enum.GetValues(typeof(VehicleClass)));
        }
        ...
        public virtual bool CanEnterParent()
        {
            return (enterableVehicles.Count > 0);
        }
