...
namespace VSX.UniversalVehicleCombat
{
    ...
    public class GameStateManager : MonoBehaviour
    {
        ...
        [SerializeField]
        protected int startingGameStateIndex;
        ...
        {
            EnterGameState(startingGameStateIndex);
        }

        /// <summary>
        /// Enter a game state by name.
        /// </summary>
        /// <param name="newGameStateName">The game state name.</param>
        public void EnterGameState(string newGameState)
        {
            int index = new List<string>(System.Enum.GetNames(typeof(GameState))).IndexOf(newGameState);

            EnterGameState((GameState)index);
        }

        /// <summary>
        /// Enter a game state by enum index.
        /// </summary>
        /// <param name="newGameStateIndex">The game state enum index.</param>
        public void EnterGameState(int newGameStateIndex)
        {
            EnterGameState((GameState)newGameStateIndex);
        }
