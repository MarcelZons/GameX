...
namespace VSX.UniversalVehicleCombat
{
    public class Warp : MonoBehaviour
    {
        ...
        [SerializeField]
        protected float rumbleRampUpTime = 0;

        [SerializeField]
        protected float rumbleSustainTime = 0;

        [SerializeField]
        protected float rumbleFadeTime = 0.25f;
            ...
            if (warping)
            {
                ...
                if (Time.time - warpStartTime > warpDelay)
                {
                    ...
                    if (addRumble && !rumbleAdded && warpAmount > rumblePosition)
                    {
                        ...
                        {
                            RumbleManager.Instance.AddRumble(endPosition, rumbleLevel, rumbleRampUpTime, rumbleSustainTime, rumbleFadeTime);
                            rumbleAdded = true;
                        }
                    }
