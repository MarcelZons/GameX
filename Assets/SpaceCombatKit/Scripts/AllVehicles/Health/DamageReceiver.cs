...
namespace VSX.UniversalVehicleCombat
{
    ...
    /// </summary>
    [System.Serializable]
    public class OnDamageReceiverDamagedEventHandler : UnityEvent<float, Vector3, DamageSourceType, Transform> { }

    /// <summary>
    /// Unity event for running functions when the damage receiver is healed.
    /// </summary>
    [System.Serializable]
    public class OnDamageReceiverHealedEventHandler : UnityEvent<float, Vector3, Transform> { }
    ...
    public class DamageReceiver : MonoBehaviour
    {
        ...
        public virtual HealthType HealthType { get { return healthType; } }
