...
namespace VSX.UniversalVehicleCombat
{
    ...
    /// </summary>
    [System.Serializable]
    public class OnDamageableDamagedEventHandler : UnityEvent<float, Vector3, DamageSourceType, Transform> { }

    /// <summary>
    /// UnityEvent to run functions when a damageable is healed.
    /// </summary>
    [System.Serializable]
    public class OnDamageableHealedEventHandler : UnityEvent<float, Vector3, Transform> { }
    ...
    public class Damageable : MonoBehaviour
    {
        ...
        public virtual float HealthCapacity { get { return healthCapacity; } }
        ...
        public virtual void OnCollision(Collision collision)
        {
            ...
            {
                Damage(collision.relativeVelocity.magnitude * collisionRelativeVelocityToDamageFactor, collision.contacts[i].point, DamageSourceType.Collision, null);
            }          
        }
        ...
        public virtual void Heal(float healing, Vector3 hitPoint, Transform damageSourceRootTransform)
        {
            ...
            if (isHealable)
            {
                ...
                onHealed.Invoke(healing, hitPoint, damageSourceRootTransform);
            }
        }
