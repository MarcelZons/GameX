...
namespace VSX.UniversalVehicleCombat.Radar
{
    ...
    public class Trackable : MonoBehaviour
    {
        ...
        // Called when this trackable is destroyed
        protected void OnDestroy()
        {
            // If registered with the TrackableSceneManager, call the event there.
            if (trackableID != -1 && TrackableSceneManager.Instance != null) TrackableSceneManager.Instance.OnTrackableDestroyed(this);
        }
