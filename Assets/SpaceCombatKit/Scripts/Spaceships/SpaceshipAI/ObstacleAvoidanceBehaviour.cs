...
namespace VSX.UniversalVehicleCombat
{
	...
	public class ObstacleAvoidanceBehaviour : AISpaceshipBehaviour
	{
        ...
        void UpdateRiskFactor(ObstacleData obstacleData, bool show)
        {
            ...
            //Debug.Log(obstacleData.raycastHit.collider.name + "  " + directionReference + "  " + obstacleData.currentPos);
		...
		public override bool BehaviourUpdate()
		{
            ...
            if (nextSphereCastIndex != -1)
            {
                ...
                // Do sphere cast
                RaycastHit[] hits = Physics.SphereCastAll(vehicle.transform.position, obstacleSphereCasts[nextSphereCastIndex].radius, projectionVector, obstacleScanDistance);
